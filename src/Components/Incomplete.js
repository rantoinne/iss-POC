    ...
    showTaskCount() {
        if(this.state.pendingCount > 1) {
            ToastAndroid.showWithGravityAndOffset(
                `${this.state.pendingCount} tasks are incomplete`,
                ToastAndroid.SHORT,
                ToastAndroid.BOTTOM,
                0,
                50,
            ...
            ToastAndroid.showWithGravityAndOffset(
                `${this.state.pendingCount} task is incomplete`,
                ToastAndroid.SHORT,
                ToastAndroid.BOTTOM,
                0,
                50,
        ...
        return data.map((item, index)=> {
            return (
                ...
                <View style= {{width, paddingVertical: 10, paddingHorizontal: 10, marginTop: 1, borderBottomWidth: 1, borderColor: '#bdc3c7', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                    ...
                    <View>
                        <Entypo 
                            name= "circle-with-minus" color= "#f5365c" size= {30} style= {{alignSelf: 'center', marginRight: 10}} /> 
                    </View>
                </View>
                </TouchableNativeFeedback>
            )
            ...
            return (
                <View style= {{flex: 1, justifyContent: 'flex-start', alignItems: 'center'}}>
...

                    {
                        ...
                        <View style= {{position: 'absolute', right: 0, bottom: -20, width: 70, height: 70, borderTopLeftRadius: 70, justifyContent: 'center', alignItems: 'center', backgroundColor: '#27345C', elevation: 8}}>
                            {
...
export default withNavigation(Incomplete);