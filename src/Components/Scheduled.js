        ...
        AsyncStorage.getItem('authToken').then((value) => {
			if(value!== null) {
                ...
                .then((response) => {
                    ...
                    this.setState({
                        pendingCount: response.UserData.scheduledStatus
                    });
                });
        ...
        return data.map((item, index)=> {
            return (
                <TouchableNativeFeedback
                    ...
                    background={TouchableNativeFeedback.Ripple('#11cdef40')}>
                <View style= {{width, paddingVertical: 10, paddingHorizontal: 10, marginTop: 1, borderBottomWidth: 1, borderColor: '#bdc3c7', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                    ...
                    <View>
                        <Entypo 
                            ...
                            name= "stopwatch" color= "green" size= {30} style= {{alignSelf: 'center', marginRight: 10}} /> 
                    </View>
                </View>
                </TouchableNativeFeedback>
            )
...
export default withNavigation(Scheduled);